...
ESVN_REPO_URI="https://svn.listen-project.org/listen/trunk-0.6"

inherit eutils virtualx subversion

DESCRIPTION="A Music player and management for GNOME"
HOMEPAGE="http://www.listen-project.org"
SRC_URI=""
LICENSE="GPL-2"
IUSE="aac flac ipod mad vorbis libsexy musicbrainz"
SLOT="0"
KEYWORDS="~x86 ~amd64"
...
pkg_postinst() {
	...
	echo "LD_LIBRARY_PATH=\"${GTKMOZEMBED_PATH}\"" "python /usr/lib/listen/listen \"\$@\"" >> /usr/bin/listen
}
